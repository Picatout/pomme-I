...
Hexadecimal [24-Bits]
                           ...
                           000002    60 MON_REV=2
                                     ...
                                     63 
      008BC4 70 6F 6D 6D 65 20 49    64 mon_str: .asciz "pomme I monitor\n"
             20 6D 6F 6E 69 74 6F
             72 0A 00
      008BD5 43 6F 70 79 72 69 67    65 mon_copyright: .asciz "Copyright, Jacques Deschenes 2023,24\n" 
             ...
             34 0A 00
                                     66 
      008BFB                         67 GO_BASIC: 
      008BFB CD 85 EA         [ 4]   68     call new_line
      008BFE CC 97 53         [ 2]   69     jp P1BASIC 
      008C01                         70 GO_FORTH:
      008C01 CC AC 72         [ 2]   71     jp forth_init 
      008C04                         72 WOZMON:: 
      008C04 AE 8B C4         [ 2]   73     ldw x,#mon_str
      008C07 90 AE 8B D5      [ 2]   74     ldw y,#mon_copyright 
                                     75 ;push app_info() parameters 
      008C0B 4B 02            [ 1]   76     push #MON_REV 
      008C0D 4B 00            [ 1]   77     push #MON_MINOR 
      008C0F 4B 01            [ 1]   78     push #MON_MAJOR 
      008C11 CD 89 47         [ 4]   79     call app_info 
...
Hexadecimal [24-Bits]
      ...
      000050                         80     _drop 3
      008C14 5B 03            [ 2]    1     addw sp,#3 
      008C16                         81 GETLINE: 
      008C16 A6 0D            [ 1]   82     ld a,#CR 
      008C18 CD 85 81         [ 4]   83     call putc 
      008C1B A6 23            [ 1]   84     ld a,#'# 
      008C1D CD 85 81         [ 4]   85     call putc
      008C20 90 5F            [ 1]   86     clrw y 
      008C22 20 09            [ 2]   87     jra NEXTCHAR 
      008C24                         88 BACKSPACE:
      008C24 90 5D            [ 2]   89     tnzw y 
      008C26 27 05            [ 1]   90     jreq NEXTCHAR 
      008C28 CD 85 D8         [ 4]   91     call bksp 
      008C2B 90 5A            [ 2]   92     decw y 
      008C2D                         93 NEXTCHAR:
      008C2D CD 85 AC         [ 4]   94     call getc
      008C30 A1 08            [ 1]   95     cp a,#BS  
      008C32 27 F0            [ 1]   96     jreq BACKSPACE 
      008C34 A1 1B            [ 1]   97     cp a,#ESC 
      008C36 27 DE            [ 1]   98     jreq GETLINE ; rejected characters cancel input, start over  
      008C38 A1 02            [ 1]   99     cp a,#CTRL_B 
      008C3A 27 BF            [ 1]  100     jreq GO_BASIC 
      008C3C A1 06            [ 1]  101     cp a,#CTRL_F
      008C3E 27 C1            [ 1]  102     jreq GO_FORTH 
      008C40 A1 60            [ 1]  103     cp a,#'`
      008C42 2B 02            [ 1]  104     jrmi UPPER ; already uppercase 
                                    105 ; uppercase character
                                    106 ; all characters from 0x60..0x7f 
                                    107 ; are folded to 0x40..0x5f     
      008C44 A4 DF            [ 1]  108     and a,#0XDF  
      008C46                        109 UPPER: ; there is no lower case letter in buffer 
      008C46 90 D7 16 80      [ 1]  110     ld (tib,y),a 
      008C4A CD 85 81         [ 4]  111     call putc
      008C4D A1 0D            [ 1]  112     cp a,#CR 
      008C4F 27 04            [ 1]  113     jreq EOL
      008C51 90 5C            [ 1]  114     incw y 
      008C53 20 D8            [ 2]  115     jra NEXTCHAR  
      008C55                        116 EOL: ; end of line, now analyse input 
      008C55 90 AE FF FF      [ 2]  117     ldw y,#-1
      008C59 4F               [ 1]  118     clr a  
      008C5A                        119 SETMODE: 
      000096                        120     _straz MODE  
      008C5A B7 38                    1     .byte 0xb7,MODE 
      008C5C                        121 BLSKIP: ; skip blank  
      008C5C 90 5C            [ 1]  122     incw y 
      008C5E                        123 NEXTITEM:
      008C5E 90 D6 16 80      [ 1]  124     ld a,(tib,y)
      008C62 A1 0D            [ 1]  125     cp a,#CR ; 
      008C64 27 B0            [ 1]  126     jreq GETLINE ; end of input line  
      008C66 A1 2E            [ 1]  127     cp a,#XAM_BLOK
      008C68 2B F2            [ 1]  128     jrmi BLSKIP 
      008C6A 27 EE            [ 1]  129     jreq SETMODE 
      008C6C A1 3A            [ 1]  130     cp a,#STOR 
      008C6E 27 EA            [ 1]  131     jreq SETMODE 
      008C70 A1 52            [ 1]  132     cp a,#'R 
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (STMicroelectronics STM8), page 40.
Hexadecimal [24-Bits]



      008C72 27 44            [ 1]  133     jreq RUN
      0000B0                        134     _stryz YSAV ; save for comparison
      008C74 90 BF 30                 1     .byte 0x90,0xbf,YSAV 
      008C77 5F               [ 1]  135     clrw x 
      008C78                        136 NEXTHEX:
      008C78 90 D6 16 80      [ 1]  137     ld a,(tib,y)
      008C7C A8 30            [ 1]  138     xor a,#0x30 
      008C7E A1 0A            [ 1]  139     cp a,#10 
      008C80 2B 06            [ 1]  140     jrmi DIG 
      008C82 A1 71            [ 1]  141     cp a,#0x71 
      008C84 2B 10            [ 1]  142     jrmi NOTHEX 
      008C86 A0 67            [ 1]  143     sub a,#0x67
      008C88                        144 DIG: 
      008C88 4B 04            [ 1]  145     push #4
      008C8A 4E               [ 1]  146     swap a 
      008C8B                        147 HEXSHIFT:
      008C8B 48               [ 1]  148     sll a 
      008C8C 59               [ 2]  149     rlcw x  
      008C8D 0A 01            [ 1]  150     dec (1,sp)
      008C8F 26 FA            [ 1]  151     jrne HEXSHIFT
      008C91 84               [ 1]  152     pop a 
      008C92 90 5C            [ 1]  153     incw y
      008C94 20 E2            [ 2]  154     jra NEXTHEX
      008C96                        155 NOTHEX:
      008C96 90 B3 30         [ 2]  156     cpw y,YSAV 
      008C99 26 03            [ 1]  157     jrne GOTNUMBER
      008C9B CC 8C 16         [ 2]  158     jp GETLINE ; no hex number  
      008C9E                        159 GOTNUMBER: 
      0000DA                        160     _ldaz MODE 
      008C9E B6 38                    1     .byte 0xb6,MODE 
      008CA0 26 09            [ 1]  161     jrne NOTREAD ; not READ mode  
                                    162 ; set XAM and STOR address 
      0000DE                        163     _strxz XAMADR 
      008CA2 BF 32                    1     .byte 0xbf,XAMADR 
      0000E0                        164     _strxz STORADR 
      008CA4 BF 34                    1     .byte 0xbf,STORADR 
      0000E2                        165     _strxz LAST 
      008CA6 BF 36                    1     .byte 0xbf,LAST 
      008CA8 4F               [ 1]  166     clr a 
      008CA9 20 16            [ 2]  167     jra NXTPRNT 
      008CAB                        168 NOTREAD:  
                                    169 ; which mode then?        
      008CAB A1 3A            [ 1]  170     cp a,#': 
      008CAD 26 0C            [ 1]  171     jrne XAM_BLOCK
      008CAF 9F               [ 1]  172     ld a,xl 
      0000EC                        173     _ldxz STORADR 
      008CB0 BE 34                    1     .byte 0xbe,STORADR 
      008CB2 F7               [ 1]  174     ld (x),a 
      008CB3 5C               [ 1]  175     incw x 
      0000F0                        176     _strxz STORADR 
      008CB4 BF 34                    1     .byte 0xbf,STORADR 
      008CB6                        177 TONEXTITEM:
      008CB6 20 A6            [ 2]  178     jra NEXTITEM 
      008CB8                        179 RUN:
...
Hexadecimal [24-Bits]
      ...
      008CB8 BE 32                    1     .byte 0xbe,XAMADR 
      008CBA FC               [ 2]  181     jp (x)
      008CBB                        182 XAM_BLOCK:
      0000F7                        183     _strxz LAST 
      008CBB BF 36                    1     .byte 0xbf,LAST 
      0000F9                        184     _ldxz XAMADR
      008CBD BE 32                    1     .byte 0xbe,XAMADR 
      008CBF 5C               [ 1]  185     incw x 
      008CC0 9F               [ 1]  186     ld a,xl
      008CC1                        187 NXTPRNT:
      008CC1 26 12            [ 1]  188     jrne PRDATA 
      008CC3 A6 0D            [ 1]  189     ld a,#CR 
      008CC5 CD 85 81         [ 4]  190     call putc 
      008CC8 9E               [ 1]  191     ld a,xh 
      008CC9 CD 8C EA         [ 4]  192     call PRBYTE 
      008CCC 9F               [ 1]  193     ld a,xl 
      008CCD CD 8C EA         [ 4]  194     call PRBYTE 
      008CD0 A6 3A            [ 1]  195     ld a,#': 
      008CD2 CD 85 81         [ 4]  196     call putc 
      008CD5                        197 PRDATA:
      008CD5 A6 20            [ 1]  198     ld a,#SPACE 
      008CD7 CD 85 81         [ 4]  199     call putc
      008CDA F6               [ 1]  200     ld a,(x)
      008CDB CD 8C EA         [ 4]  201     call PRBYTE
      008CDE 5C               [ 1]  202     incw x
      008CDF 27 D5            [ 1]  203     jreq TONEXTITEM ; rollover 
      008CE1                        204 XAMNEXT:
      008CE1 B3 36            [ 2]  205     cpw x,LAST 
      008CE3 22 D1            [ 1]  206     jrugt TONEXTITEM
      008CE5                        207 MOD8CHK:
      008CE5 9F               [ 1]  208     ld a,xl 
      008CE6 A4 07            [ 1]  209     and a,#7 
      008CE8 20 D7            [ 2]  210     jra NXTPRNT
      008CEA                        211 PRBYTE:
      008CEA CD 88 2A         [ 4]  212     call print_hex
      008CED 81               [ 4]  213     ret 
      008CEE                        214 ECHO:
      008CEE CD 85 81         [ 4]  215     call putc 
      008CF1 81               [ 4]  216     RET 
                                    217 
                                    218 ;----------------------------
